...
namespace MG.MyCollege
{
    ...
    {
        private frmMainApp Form { get; set; }

        public GenerateControls(List<ItemToReplace> itemToReplaces, frmMainApp form)
        {
        ...
        private void txtEntityNameSingular_TextChanged(object sender, EventArgs e)
        {
            try
            {
                var c10 = (System.Windows.Forms.TextBox)Form.Controls.Find(GetItem(10), true)[0];
                var c11 = (System.Windows.Forms.TextBox)Form.Controls.Find(GetItem(11), true)[0];
                var c12 = (System.Windows.Forms.TextBox)Form.Controls.Find(GetItem(12), true)[0];
                var c13 = (System.Windows.Forms.TextBox)Form.Controls.Find(GetItem(13), true)[0];
        ...
        private System.Windows.Forms.RichTextBox GetRichTextBox(ItemFileToGenerate item)
        {
